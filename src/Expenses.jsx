...
const categories = [
    "property mng", "inventory", "elektrina", "voda", "smeti", "poistenie", "internet", "kamera", "web", "banka", "uctovnictvo", "pravnik-notar", "interier-opravy", "community fee", "smeti", "licencia", "dane",
];
