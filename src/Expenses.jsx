...
const categories = [
  "interier-opravy", "property mng", "inventory", "elektrina", "voda", "smeti", "internet", "kamera", "web", "banka", "uctovnictvo", "pravnik-notar", "community fee", "smeti", "licencia", "dane", "reklama", "poistenie"];
...
function Expenses({
  ...
  const expensesForPreviousYear = safeExpensesList.filter((exp) => String(exp.year) === String(previousYear));
    ...
    <div>
      <>
        ...
        <h3 style={{ marginTop: "50px" }}>
          Zoznam nákladov v roku {previousYear}
        </h3>
        {expensesForPreviousYear.length === 0 ? (
          <p>Žiadne náklady</p>
        ) : (
          <table style={{ width: "100%", borderCollapse: "collapse", marginTop: "10px" }}>
            <thead>
